...
#ifndef PC_LIBPC_SRC_PC_NETWORK_DPDK_TRANSPORT_H_
#define PC_LIBPC_SRC_PC_NETWORK_DPDK_TRANSPORT_H_
...
namespace pc
{
    namespace network
    {
        ...
        // Agora parameter
        static constexpr size_t kRxRingSize = 4096;
        static constexpr size_t kTxRingSize = 4096;
        ...
        static constexpr size_t kPayloadOffset = sizeof(rte_ether_hdr) + sizeof(rte_ipv4_hdr) + sizeof(rte_udp_hdr);
        ...
        public:
            ...
            static void DpdkInit(uint16_t core_offset, size_t thread_num = 1);
...
#endif // PC_LIBPC_SRC_PC_NETWORK_DPDK_TRANSPORT_H_
