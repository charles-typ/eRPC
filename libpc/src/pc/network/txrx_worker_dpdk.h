...
#ifndef PC_LIBPC_SRC_PC_NETWORK_TXRX_WORKER_DPDK_H_
#define PC_LIBPC_SRC_PC_NETWORK_TXRX_WORKER_DPDK_H_
#include <cstddef>
#include <cstdint>
#include <vector>
...
namespace pc
{
  namespace network
  {
    ...
    public:
      ...
      TxRxWorkerDpdk(Config* cfg, size_t core_offset, size_t tid,
...
#endif // PC_LIBPC_SRC_PC_NETWORK_TXRX_WORKER_DPDK_H_